...
'''Write a DAG which creates an employe table 
each row represents a new person and contains info about their name and age
then insert 3 people (with the correct metadata)
finally execute a query which calculates the average age of all employees'''
create_query = """
CRATE TABLE IF NOT EXISTS  employees (
...
dag_postgres = DAG(dag_id = "postgres_dag_connection", 
